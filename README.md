...
Работу программы с реализацией на Shiny (Plug-in и ЛДФ) можно посмотреть [здесь](https://vladislav-duma.shinyapps.io/linear_classifiers/)
...
Работу программы с реализацией на Shiny (Персептрон Розенблатта) можно посмотреть [здесь](https://vladislav-duma.shinyapps.io/linear_classifiers/)
...
Работу программы с реализацией на Shiny (Логистическая регрессия) можно посмотреть [здесь](https://vladislav-duma.shinyapps.io/linear_classifiers/)
